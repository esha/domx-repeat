A [DOMx][domx] extension that makes it easy to dynamically repeat DOM structures.
...
* 2015-03-12 [v0.3.0][] (x-repeat-init control)
...
[v0.3.0]: https://github.com/esha/domx/tree/0.3.0
